                        ...
                        if (quantityDetail) {
                            ...
                            if (checkFraction) {
                                ...
                                if (extractFraction.includes(" ")){
                                    errorNotice.innerHTML="Sorry. The nutritional information is currently unavailable.";
...
var getNutrients = async function (ingredientsArr, quantityArr) {
    nutritionalInfo = { calories: 0, totalFat: 0, cholesterol: 0, sodium: 0, carbs: 0, protein: 0, vitaminA: 0, vitaminC: 0, vitaminD: 0, vitaminK: 0, calcium: 0, iron: 0, potassium: 0, magnesium: 0, };
